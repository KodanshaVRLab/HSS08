	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 staticSwitch157 = float2( 1,0 );
				#endif
				float2 normalizeResult30_g9 = normalize( staticSwitch157 );
				...
				float2 staticSwitch121 = cellCenter2D25;
				#endif
				float2 temp_output_22_0_g9 = staticSwitch121;
				float2 temp_output_5_0_g9 = ( staticSwitch136.xy - temp_output_22_0_g9 );
				float dotResult31_g9 = dot( normalizeResult30_g9 , temp_output_5_0_g9 );
				float2 temp_output_32_0_g9 = ( dotResult31_g9 * normalizeResult30_g9 );
				...
				float temp_output_4_0_g9 = cos( ( transitionValue59 * ( ( _FlipCount * 0.5 ) * PI ) ) );
				...
				#elif defined(_UVMODE_OBJECTPLANAR)
				float2 staticSwitch122 = ( appendResult140 / appendResult142 );
				#else
				float2 staticSwitch122 = cellRadius2D34;
				#endif
				float2 temp_output_9_0_g9 = ( temp_output_32_0_g9 * ( 1.0 / ( temp_output_4_0_g9 * staticSwitch122.x ) ) * staticSwitch122.x );
				float temp_output_12_0_g9 = step( temp_output_4_0_g9 , 0.0 );
				float2 lerpResult17_g9 = lerp( temp_output_9_0_g9 , -temp_output_9_0_g9 , temp_output_12_0_g9);
				float2 temp_output_33_0_g9 = ( temp_output_5_0_g9 - temp_output_32_0_g9 );
				float2 outputCoord41 = ( ( lerpResult17_g9 + temp_output_33_0_g9 ) + temp_output_22_0_g9 );
				float2 temp_output_1_0_g18 = outputCoord41;
				float sideIndex87 = temp_output_12_0_g9;
				float4 lerpResult5_g18 = lerp( tex2D( _SideA, temp_output_1_0_g18 ) , tex2D( _SideB, temp_output_1_0_g18 ) , sideIndex87);
				float temp_output_3_0_g10 = ( staticSwitch122.x - abs( temp_output_9_0_g9 ).x );
				float outputMask42 = saturate( ( temp_output_3_0_g10 / fwidth( temp_output_3_0_g10 ) ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( lerpResult5_g18 * outputMask42 ).rgb;
				float Alpha = 1;
...
Node;AmplifyShaderEditor.FunctionNode;115;-1204.743,-320.8907;Inherit;False;UV Grid;11;;5;00fc8464f2b1b2f4182579db99f68779;0;1;10;FLOAT3;0,0,0;False;4;FLOAT2;0;FLOAT3;13;FLOAT2;11;FLOAT;28
Node;AmplifyShaderEditor.RangedFloatNode;68;-4402.395,1844.057;Inherit;False;Property;_FlipFuzz;Flip Fuzz;14;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-3890.73,1008.296;Inherit;False;Property;_Transition;Transition;13;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;123;-3273.962,161.8336;Inherit;False;117;cellCenter3D;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;113;1132.209,374.8884;Inherit;False;Property;_Cull;Cull;6;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CullMode;True;0;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TransformDirectionNode;128;-2891.759,785.4028;Inherit;False;Object;World;False;Fast;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;129;-2422.411,104.2395;Inherit;False;Random Range;-1;;6;7b754edb8aebbfb4a9ace907af661cfc;0;3;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;124;-2644.173,727.7828;Inherit;False;118;cellRadius3D;1;0;OBJECT;;False;1;FLOAT;0
...
WireConnection;160;21;136;0
WireConnection;160;22;121;0
WireConnection;160;24;122;0
WireConnection;160;29;157;0
WireConnection;160;23;60;0
WireConnection;1;2;137;0
ASEEND*/
//CHKSM=9948AB0A1238A208039192D2C8AA53F97274CBEF