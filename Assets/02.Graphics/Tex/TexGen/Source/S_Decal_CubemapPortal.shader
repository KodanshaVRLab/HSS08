...
Shader  "S_Decal_CubemapPortal"
{
	Properties
    {
        ...
        [HDR]_ColorA("Color A", Color) = (0,0.0008990982,0.03773582,1)
        [HDR]_ColorB("Color B", Color) = (0.2202176,0,1.515717,1)
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			)
			{
				...
				float mulTime12 = _TimeParameters.x * 0.2;
				float temp_output_13_0 = frac( mulTime12 );
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - positionWS );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float4 texCUBENode10 = texCUBE( _PortalCubemap, ase_worldViewDir );
				float smoothstepResult14 = smoothstep( ( temp_output_13_0 - 0.05 ) , temp_output_13_0 , texCUBENode10.r);
				float smoothstepResult15 = smoothstep( ( temp_output_13_0 + 0.05 ) , temp_output_13_0 , texCUBENode10.r);
				float temp_output_22_0 = ( temp_output_13_0 + 1.0 );
				float smoothstepResult26 = smoothstep( ( temp_output_22_0 - 0.05 ) , temp_output_22_0 , texCUBENode10.r);
				float smoothstepResult27 = smoothstep( ( temp_output_22_0 + 0.05 ) , temp_output_22_0 , texCUBENode10.r);
				float temp_output_29_0 = ( ( smoothstepResult14 * smoothstepResult15 ) + ( smoothstepResult26 * smoothstepResult27 ) );
				float4 lerpResult42 = lerp( _ColorA , _ColorB , temp_output_29_0);
				
				float2 uv_MaskTexture = texCoord0 * _MaskTexture_ST.xy + _MaskTexture_ST.zw;
				float temp_output_127_0 = pow( _Erode , 1.5 );
				float lerpResult124 = lerp( 0.0 , ( 1.0 + 1.0 ) , temp_output_127_0);
				float lerpResult122 = lerp( -1.0 , 1.0 , temp_output_127_0);
				...
				float2 coords99 = temp_output_109_0 * ( 12.23 * pow( dotResult110 , 0.33 ) );
				float2 id99 = 0;
				float2 uv99 = 0;
				...
				float temp_output_36_0 = ( 1.0 * tex2D( _MaskTexture, uv_MaskTexture ).a * smoothstepResult114 );
				

				surfaceDescription.BaseColor = lerpResult42.rgb;
				surfaceDescription.Alpha = step( 0.001 , temp_output_36_0 );
        ...
        Pass
        {
			...
			)
			{
				...
				float mulTime12 = _TimeParameters.x * 0.2;
				float temp_output_13_0 = frac( mulTime12 );
				float4 texCUBENode10 = texCUBE( _PortalCubemap, packedInput.viewDirectionWS );
				float smoothstepResult14 = smoothstep( ( temp_output_13_0 - 0.05 ) , temp_output_13_0 , texCUBENode10.r);
				float smoothstepResult15 = smoothstep( ( temp_output_13_0 + 0.05 ) , temp_output_13_0 , texCUBENode10.r);
				float temp_output_22_0 = ( temp_output_13_0 + 1.0 );
				float smoothstepResult26 = smoothstep( ( temp_output_22_0 - 0.05 ) , temp_output_22_0 , texCUBENode10.r);
				...
				#ifdef SUPPORT_QUEST3_OCCLUSION
				META_DEPTH_OCCLUDE_OUTPUT_PREMULTIPLY_WORLDPOS(positionWS, color, 0.0);
				#endif
...
Node;AmplifyShaderEditor.SamplerNode;10;-1402.854,73.01345;Inherit;True;Property;_PortalCubemap;Portal Cubemap;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;LockedToCube;False;Object;-1;Auto;Cube;8;0;SAMPLERCUBE;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;11;-1650.853,98.01343;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleTimeNode;12;-1595.22,501.7581;Inherit;False;1;0;FLOAT;0.2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-600.9875,368.6602;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;17;-1143.348,680.9084;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-1414.348,693.9084;Inherit;False;Constant;_Float0;Float 0;2;0;Create;True;0;0;0;False;0;False;0.05;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;16;-1118.907,554.6988;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-1386.737,1096.54;Inherit;False;Constant;_Float1;Float 0;2;0;Create;True;0;0;0;False;0;False;0.05;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;14;-858.1733,299.2811;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;15;-858.1733,431.2818;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;26;-816.6409,854.2645;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;27;-816.6409,986.2651;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;22;-1255.019,887.4189;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;23;-1090.209,1042.474;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;25;-1065.768,916.2639;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;-613.1068,918.5287;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;29;-352.0825,521.2253;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DecodeDepthNormalNode;31;-213.3067,-676.8694;Inherit;False;1;0;FLOAT4;0,0,0,0;False;2;FLOAT;0;FLOAT3;1
...
Node;AmplifyShaderEditor.ColorNode;40;-232.2735,616.315;Inherit;False;Property;_ColorA;Color A;3;1;[HDR];Create;True;0;0;0;False;0;False;0,0.0008990982,0.03773582,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;41;-233.6678,794.6161;Inherit;False;Property;_ColorB;Color B;4;1;[HDR];Create;True;0;0;0;False;0;False;0.2202176,0,1.515717,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SmoothstepOpNode;46;-7.321838,34.5582;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.2;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;96;69.68855,-340.438;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.05;False;2;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;99;-591.4646,1367.058;Inherit;True;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
Node;AmplifyShaderEditor.PowerNode;111;-1083.075,1552.664;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;0.33;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;100;-1110.111,1472.477;Inherit;False;Constant;_Float2;Float 2;6;0;Create;True;0;0;0;False;0;False;12.23;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;88;842.1367,19.67608;Float;False;True;-1;2;UnityEditor.Rendering.Universal.DecalShaderGraphGUI;0;14;S_Decal_CubemapPortal;7f1ca7c501025c34a87e6fcb23bc2050;True;DecalScreenSpaceProjector;0;2;DecalScreenSpaceProjector;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;5;RenderPipeline=UniversalPipeline;PreviewType=Plane;DisableBatching=LODFading=DisableBatching;ShaderGraphShader=true;ShaderGraphTargetId=UniversalDecalSubTarget;True;3;True;12;all;0;False;True;2;5;False;;10;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;True;2;False;;False;True;1;LightMode=DecalScreenSpaceProjector;False;False;0;;0;0;Standard;9;Lit;0;638409978158243136;Affect BaseColor;1;0;Affect Normal;1;0;Blend;1;0;Affect MAOS;0;0;Affect Emission;0;0;Support LOD CrossFade;0;0;Angle Fade;1;0;Support Quest3 Occlusion;1;638406234981729994;0;9;True;False;True;True;True;False;True;True;True;False;;False;0
...
Node;AmplifyShaderEditor.RangedFloatNode;120;-1420.193,1790.101;Inherit;False;Constant;_Float5;Float 4;6;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;127;-1228.241,1247.012;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;42;276.1535,552.4389;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;45;154.1384,266.8435;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;2;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;44;239.3165,-242.703;Inherit;False;Step Antialiasing;-1;;1;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0.005;False;2;FLOAT;0.001;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=61E8C2DB5E5E3222D52E87341F98C2283501E004