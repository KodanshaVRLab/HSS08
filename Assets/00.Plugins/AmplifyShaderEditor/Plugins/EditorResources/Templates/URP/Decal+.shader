Shader  /*ase_name*/"Hidden/Universal/Decal Plus"/*end*/
{
	Properties
    {
        /*ase_props*/
    ...
    SubShader
    {
		/*ase_subshader_options:Name=Additional Options
			Option:Lit:false,true:true
				true:SetDefine:_LIT_DECAL 1
				false:RemoveDefine:_LIT_DECAL 1
			...
			Option:Support Quest3 Occlusion:false,true:false
				true:SetDefine:SUPPORT_QUEST3_OCCLUSION 1
				true:SetShaderProperty:_MetaDepthOcclusionBias,_MetaDepthOcclusionBias("Occlusion Depth Bias", Float) = 0
				false:RemoveDefine:SUPPORT_QUEST3_OCCLUSION 1
				false:SetShaderProperty:_MetaDepthOcclusionBias,[HideInInspector] _MetaDepthOcclusionBias("Occlusion Depth Bias", Float) = 0
		*/
